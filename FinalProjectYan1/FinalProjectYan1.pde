...
public void mousePressed() {
  ...
  println();
  if (pauseMenu == true) {
    if  (mouseY <= 300 && mouseY >= 200 && mouseX > 100 && mouseX < 300) {
    ...
    if  (mouseY <= 300 && mouseY >= 200 && mouseX > 400 && mouseX < 600) {
      levelTimer = 0;
      level = 1;
    ...
    if  (mouseY <= 500 && mouseY >= 400 && mouseX > 245 && mouseX < 445) {
      levelTimer = 0;
      level = 0;
      levelSelect = 0;
      pauseMenu = false;
  ...
  if (levelSelect == 0 ) { 
    ...
    if  (mouseY <= 300 && mouseY >= 200 && mouseX > 100 && mouseX < 300 && level == 0) {
      levelSelect = 0;
    ...
    if  (mouseY <= 300 && mouseY >= 200 && mouseX > 400 && mouseX < 600 && level == 0) {
      exit();
    }


    if  (mouseY <= 500 && mouseY >= 400 && mouseX > 245 && mouseX < 445 && level == 0 &&   levelSelect == 0) {
      levelSelect = 1;
      json = loadJSONObject("data/data.json");
      levelUnlocked = json.getInt("levelUnlocked");
    }
  ...
  if (levelSelect == -1) {
    ...
    if (mouseY <= 540 && mouseY >= 440 && mouseX > 30 && mouseX < 230) {
      levelSelect++;
      return;
    }
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 130 && mouseX < 180) {
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 230 && mouseX < 230 + 50) {
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 330 && mouseX < 330 + 50) {
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 430 && mouseX < 430 + 50) {
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 530 && mouseX < 530 + 50) {
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 230 && mouseX < 230 + 50) {
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 330 && mouseX < 330 + 50) {
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 430 && mouseX < 430 + 50) {
    ...
    if  (mouseY <= 500 && mouseY >= 450 && mouseX > 330 && mouseX < 330 + 50) {
    ...
    if  (mouseY <= 500 && mouseY >= 4 && mouseX > 480 && mouseX < 680 + 50) {
    }

    if  (mouseY <= 540 && mouseY >= 440 && mouseX > 480 && mouseX < 680 + 50) {
  ...
  if (levelSelect == 1) {
    ...
    if (mouseY <= 540 && mouseY >= 440 && mouseX > 30 && mouseX < 230 && level == 0) {
      levelTimer = 0;
      level = 0;
      levelSelect--;
      pauseMenu = false;
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 130 && mouseX < 180 && level == 0) {
      if (1 <= levelUnlocked) {
        levelSelect = 0;
        level = 1;
        levelTimer = 0;
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 230 && mouseX < 230 + 50 && level == 0) {
      if (2 <= levelUnlocked) {
        levelSelect = 0;
        level = 2;
        levelTimer = 0;
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 330 && mouseX < 330 + 50 && level == 0) {
      if (3 <= levelUnlocked) {
        levelSelect = 0;
        level = 3;
        levelTimer = 0;
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 430 && mouseX < 430 + 50 && level == 0) {
      if (4 <= levelUnlocked) {
        levelSelect = 0;
        level = 4;
        levelTimer = 0;
    ...
    if  (mouseY <= 300 && mouseY >= 250 && mouseX > 530 && mouseX < 530 + 50 && level == 0) {
      if (5 <= levelUnlocked) {
        levelSelect = 0;
        level = 5;
        levelTimer = 0;
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 230 && mouseX < 230 + 50 && level == 0) {
      if (6 <= levelUnlocked) {
        levelSelect = 0;
        level = 6;
        levelTimer = 0;
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 330 && mouseX < 330 + 50 && level == 0) {
      if (7 <= levelUnlocked) {
        levelSelect = 0;
        level = 7;
        levelTimer = 0;
    ...
    if  (mouseY <= 400 && mouseY >= 350 && mouseX > 430 && mouseX < 430 + 50 && level == 0) {
      if (8 <= levelUnlocked) {
        levelSelect = 0;
        level = 8;
        levelTimer = 0;
    ...
    if  (mouseY <= 500 && mouseY >= 450 && mouseX > 330 && mouseX < 330 + 50 && level == 0) {
      if (9 <= levelUnlocked) {
        levelSelect = 0;
        level = 9;
        levelTimer = 0;
    ...
    if  (mouseY <= 540 && mouseY >= 440 && mouseX > 480 && mouseX < 680 + 50 && level == 0) {
  ...
  if  ( mouseY <= 450 && mouseY >= 350 && mouseX > 400 && mouseX < 600 && level == 10) {
    exit();
  }


  if  (mouseY <= 450 && mouseY >= 350 && mouseX > 100 && mouseX < 300 && level == 10) {
    level = 1;
    higherjump = false;
